...
const translations = {
  es: {
    ...
    "cmd.sale_ar": "Venta",
    "cmd.cancelsale_ar": "Cancelar Venta",
    "cmd.return_ar": "Devolución",
    "cmd.shift_ar": "Operación de Turno",
    "cmd.shiftreport_ar": "Reporte de Turno",
    "cmd.normalmode_ar": "Modo Normal",
    ...
    "triad.pasteSuccess": "Tríada autocompletada con éxito",
    "triad.pasteTooltip": "Pegado Especial (Autocompletar Tríada)",
    "field.planId": "ID Plan",
    "field.interest": "Interés",
    "field.operationMode": "Modo Operación",
    "field.skipConfirmation": "Omitir Confirmación",
    "field.skiptConfirmation": "Omitir Confirmación",
    "field.skipReceipt": "Omitir Comprobante",
    "field.shiftOperation": "Operación de Turno",
    "field.numberOfShift": "Número de Turno",
    ...
    exportConfig: "Exportar Configuración (Credenciales, Tríadas y Ajustes)",
    importConfig: "Importar Configuración (Archivo JSON)",
    configExported: "Configuración exportada exitosamente",
    configImported: "¡Configuración e historial de tríadas importados con éxito!",
    exportSecurityTitle: "Aviso de Seguridad de Exportación",
    exportSecurityDesc: "El archivo de configuración que vas a exportar contiene información confidencial (Client ID y Client Secret) de tu entorno actual. Guárdalo en una ubicación segura y evita compartirlo en repositorios o canales públicos.",
    exportSecurityCredsNotice: "Contiene credenciales activas Client ID & Client Secret",
    exportSecurityTriadsNotice: "Contiene tríadas guardadas y parámetros del terminal POS",
    exportSecurityConfirmBtn: "Entendido, Exportar Archivo",
  ...
  en: {
    ...
    "cmd.sale_ar": "Sale",
    "cmd.cancelsale_ar": "Cancel Sale",
    "cmd.return_ar": "Return",
    "cmd.shift_ar": "Shift Operation",
    "cmd.shiftreport_ar": "Shift Report",
    "cmd.normalmode_ar": "Normal Mode",
    ...
    "triad.pasteSuccess": "Triad autocompleted successfully",
    "triad.pasteTooltip": "Special Paste (Autocomplete Triad)",
    "field.planId": "Plan ID",
    "field.interest": "Interest",
    "field.operationMode": "Operation Mode",
    "field.skipConfirmation": "Skip Confirmation",
    "field.skiptConfirmation": "Skip Confirmation",
    "field.skipReceipt": "Skip Receipt",
    "field.shiftOperation": "Shift Operation",
    "field.numberOfShift": "Shift Number",
    "field.originalTransDate": "Original Operation Date",
    "field.originalDate": "Original Date",
    "field.originalTime": "Original Time",
    ...
    exportConfig: "Export Configuration (Credentials, Triads & Settings)",
    importConfig: "Import Configuration (JSON File)",
    configExported: "Configuration exported successfully",
    configImported: "Configuration and saved triads imported successfully!",
    exportSecurityTitle: "Export Security Warning",
    exportSecurityDesc: "The configuration file you are about to export contains sensitive information (Client ID & Client Secret) for your environment. Make sure to save it in a secure location and do not share it in public repositories or channels.",
    exportSecurityCredsNotice: "Contains sensitive Client ID & Client Secret credentials",
    exportSecurityTriadsNotice: "Contains saved triads and POS terminal parameters",
    exportSecurityConfirmBtn: "Understood, Export File",
  ...
  pt: {
    ...
    "cmd.sale_ar": "Venda",
    "cmd.cancelsale_ar": "Cancelar Venda",
    "cmd.return_ar": "Reembolso",
    "cmd.shift_ar": "Operação de Turno",
    "cmd.shiftreport_ar": "Relatório de Turno",
    "cmd.normalmode_ar": "Modo Normal",
    "cmd.lastvoucher_ar": "Reimprimir",
    ...
    "triad.pasteSuccess": "Tríade preenchida com sucesso",
    "triad.pasteTooltip": "Colar Especial (Autocompletar Tríada)",
    "field.planId": "ID Plano",
    "field.interest": "Juros",
    "field.operationMode": "Modo de Operação",
    "field.skipConfirmation": "Omitir Confirmação",
    "field.skiptConfirmation": "Omitir Confirmação",
    "field.skipReceipt": "Omitir Recibo",
    "field.shiftOperation": "Operação de Turno",
    "field.numberOfShift": "Número de Turno",
    "field.originalTransDate": "Data da Operação Original",
    "field.originalDate": "Data Original",
    "field.originalTime": "Hora Original",
    ...
    exportConfig: "Exportar Configuração (Credenciais, Tríadas e Ajustes)",
    importConfig: "Importar Configuração (Arquivo JSON)",
    configExported: "Configuração exportada com sucesso",
    configImported: "Configuração e tríadas importadas com sucesso!",
    exportSecurityTitle: "Aviso de Segurança de Exportação",
    exportSecurityDesc: "O arquivo de configuração que você vai exportar contém informações confidenciais (Client ID e Client Secret). Salve-o em um local seguro e evite compartilhá-lo em repositórios ou canais públicos.",
    exportSecurityCredsNotice: "Contém credenciais ativas Client ID e Client Secret",
    exportSecurityTriadsNotice: "Contém tríadas salvas e parâmetros do terminal POS",
    exportSecurityConfirmBtn: "Entendido, Exportar Arquivo",
